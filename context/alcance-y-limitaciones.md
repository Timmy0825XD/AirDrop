...
- Pedidos de **emergencia** (prioridad alta, despacho inmediato) y **programados** (fecha, frecuencia, cantidad: sangre, vacunas, otros).
- Flota de drones simulados con estados de disponibilidad.
- Geovallas y zonas restringidas definidas por el operador.
- Motor de decisión: batería, carga, mantenimiento, clima **simulado**, ruta libre de geovallas, tipo de misión; emergencia gana el recurso si hay competencia.
...
- Fallback: alternativa de entrega si ningún dron es elegible.
