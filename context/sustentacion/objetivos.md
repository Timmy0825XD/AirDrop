...
2. **Diseñar e implementar** el motor de simulación del dron y el motor de decisión de elegibilidad de misión, diferenciando parámetros de emergencia y de reabastecimiento programado, e incluyendo modelo de batería, capacidad de carga, geovallas y cálculo de rutas, con buenas prácticas de arquitectura (ver [../diseno/principios.md](../diseno/principios.md)). El vuelo simulado **no** arranca al autorizar: primero se asigna el dron y el despachador confirma la carga.
